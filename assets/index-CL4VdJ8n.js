...
function o(e, t) {
  if ((t === void 0 && (t = document), e instanceof Array)) return e.filter(n);
  if (n(e)) return [e];
...
function c(e) {
  if (e.constructor !== Array) throw TypeError(`Expected array.`);
...
function u(e, t) {
  for (var n = c(e), r = c(t), i = [], a = 0; a < 4; a++)
    for (var o = [n[a], n[a + 4], n[a + 8], n[a + 12]], s = 0; s < 4; s++) {
      var l = s * 4,
...
function C() {
  ...
  (x(this.store.elements, function (e) {
    n.active.indexOf(e.id) === -1 && n.stale.push(e.id);
  }),
    x(n.stale, function (t) {
      return delete e.store.elements[t];
    }),
    x(this.store.elements, function (e) {
      (i.active.indexOf(e.containerId) === -1 && i.active.push(e.containerId),
        e.hasOwnProperty(`sequence`) &&
          r.active.indexOf(e.sequence.id) === -1 &&
          r.active.push(e.sequence.id));
    }),
    x(this.store.containers, function (e) {
      i.active.indexOf(e.id) === -1 && i.stale.push(e.id);
    }),
    x(i.stale, function (t) {
    ...
    x(this.store.sequences, function (e) {
      r.active.indexOf(e.id) === -1 && r.stale.push(e.id);
    }),
...
function w(e) {
  ...
  ((i.computed = a
    ...
    (i.generated = a.some(function (e) {
      ...
      : a
          ...
          .join(`; `) + `;`));
  var o = parseFloat(t.opacity),
    s = isNaN(parseFloat(r.opacity))
      ? parseFloat(t.opacity)
      : parseFloat(r.opacity),
    c = {
      computed: o === s ? `` : `opacity: ` + o + `;`,
      generated: o === s ? `` : `opacity: ` + s + `;`,
    },
    l = [];
  if (parseFloat(r.distance)) {
    var m = r.origin === `top` || r.origin === `bottom` ? `Y` : `X`,
      h = r.distance;
    (r.origin === `top` || r.origin === `left`) &&
      (h = /^-/.test(h) ? h.substr(1) : `-` + h);
    var g = h.match(/(^-?\d+\.?\d?)|(em$|px$|%$)/g),
      _ = g[0];
    switch (g[1]) {
      case `em`:
        h = parseInt(t.fontSize) * _;
        break;
      case `px`:
        h = _;
        break;
      case `%`:
        h =
          m === `Y`
            ? (e.node.getBoundingClientRect().height * _) / 100
            : (e.node.getBoundingClientRect().width * _) / 100;
        break;
      default:
        throw RangeError(`Unrecognized or missing distance unit.`);
    }
    m === `Y` ? l.push(re(h)) : l.push(ne(h));
  }
  (r.rotate.x && l.push(ee(r.rotate.x)),
    r.rotate.y && l.push(te(r.rotate.y)),
    r.rotate.z && l.push(f(r.rotate.z)),
    r.scale !== 1 && (r.scale === 0 ? l.push(p(2e-4)) : l.push(p(r.scale))));
  var v = {};
  if (l.length) {
    ((v.property = H(`transform`)),
      (v.computed = { raw: t[v.property], matrix: d(t[v.property]) }),
      l.unshift(v.computed.matrix));
    var y = l.reduce(u);
    v.generated = {
  ...
  var b = {};
  if (c.generated || v.generated.initial) {
    ((b.property = H(`transition`)),
      (b.computed = t[b.property]),
      (b.fragments = []));
    var x = r.delay,
      S = r.duration,
      C = r.easing;
    (c.generated &&
      b.fragments.push({
        delayed: `opacity ` + S / 1e3 + `s ` + C + ` ` + x / 1e3 + `s`,
        instant: `opacity ` + S / 1e3 + `s ` + C + ` 0s`,
      }),
      v.generated.initial &&
        b.fragments.push({
          delayed: v.property + ` ` + S / 1e3 + `s ` + C + ` ` + x / 1e3 + `s`,
          instant: v.property + ` ` + S / 1e3 + `s ` + C + ` 0s`,
        }),
      b.computed &&
        !b.computed.match(/all 0s|none 0s/) &&
        b.fragments.unshift({ delayed: b.computed, instant: b.computed }));
    var w = b.fragments.reduce(
      function (e, t, n) {
        return (
    ...
    b.generated = {
      delayed: b.property + `: ` + w.delayed + `;`,
      instant: b.property + `: ` + w.instant + `;`,
    };
  } else b.generated = { delayed: ``, instant: `` };
  return { inline: i, opacity: c, position: n, transform: v, transition: b };
}
function T(e, t) {
...
function ie() {
  var e = this;
  (x(this.store.elements, function (e) {
    (T(e.node, e.styles.inline.generated),
...
function D(e) {
  ...
  if (b(e))
    return (
      x(t, function (t) {
        x(t, function (t, n) {
          b(t) ? ((!e[n] || !b(e[n])) && (e[n] = {}), D(e[n], t)) : (e[n] = t);
        });
      }),
      e
    );
...
function A(e, t) {
  ...
  if (t.reveal || i) return ae.call(this, e, r);
  if (t.reset || a) return j.call(this, e);
}
function ae(e, t) {
  var n = [
...
function N(e, t) {
  if (
    ...
    return A.call(this, e, { reset: !0 });
  var n = this.store.sequences[e.sequence.id],
    r = e.sequence.index;
  if (n) {
    var i = new F(n, `visible`, this.store),
      a = new F(n, `revealed`, this.store);
    if (((n.models = { visible: i, revealed: a }), !a.body.length)) {
      var o = n.members[i.body[0]],
        s = this.store.elements[o];
      if (s)
        return (
          I.call(this, n, i.body[0], -1, t),
          I.call(this, n, i.body[0], 1, t),
    ...
    if (
      ...
      return (
        I.call(this, n, r, -1, t),
        A.call(this, e, { reveal: !0, pristine: t })
      );
    if (
      !n.blocked.foot &&
...
function P(e) {
  ...
  else throw RangeError(`Invalid sequence interval.`);
}
function F(e, t, n) {
  var r = this;
  ((this.head = []),
...
function L(e, t, n) {
  ...
  var i = [],
    a,
    s = t.interval || B.interval;
  try {
    s && (a = new P(s));
    var c = o(e);
    if (!c.length) throw Error(`Invalid reveal target.`);
    x(
      c.reduce(function (e, n) {
        var s = {},
          c = n.getAttribute(`data-sr-id`);
        c
          ? (D(s, r.store.elements[c]), T(s.node, s.styles.inline.computed))
          : ((s.id = U()),
            (s.node = n),
            (s.seen = !1),
            (s.revealed = !1),
            (s.visible = !1));
        var l = D({}, s.config || r.defaults, t);
        if ((!l.mobile && O()) || (!l.desktop && !O()))
          return (c && E.call(r, s), e);
        var u = o(l.container)[0];
        if (!u) throw Error(`Invalid container.`);
        if (!u.contains(n)) return e;
        var d = oe(u, i, r.store.containers);
        return (
          d === null && ((d = U()), i.push({ id: d, node: u })),
          (s.config = l),
          (s.containerId = d),
          (s.styles = w(s)),
          a &&
            ((s.sequence = { id: a.id, index: a.members.length }),
            a.members.push(s.id)),
          e.push(s),
          e
        );
  ...
  (x(i, function (e) {
    ...
    n !== !0 &&
      ...
      (this.initTimeout = window.setTimeout(k.bind(this), 0))));
}
function oe(e) {
  for (var t = [], n = arguments.length - 1; n-- > 0; ) t[n] = arguments[n + 1];
  var r = null;
...
function R(e, t) {
  ...
  while (o);
  return {
    bounds: { top: i, right: a + r, bottom: i + n, left: a },
    height: n,
    width: r,
  };
}
  ...
  (e === void 0 && (e = { type: `init` }),
    ...
    g(function () {
      ...
      (x(n.store.containers, function (e) {
        r && (e.geometry = R.call(n, e, !0));
        var t = ce.call(n, e);
        (e.scroll &&
          (e.direction = {
            x: G(t.left - e.scroll.left),
            y: G(t.top - e.scroll.top),
          }),
          (e.scroll = t));
      }),
        x(t, function (e) {
          ((r || e.geometry === void 0) && (e.geometry = R.call(n, e)),
            (e.visible = le.call(n, e)));
        }),
        x(t, function (e) {
...
function z(e) {
  if (
    (e === void 0 && (e = {}),
    this === void 0 || Object.getPrototypeOf(this) !== z.prototype)
  )
    return new z(e);
  if (!z.isSupported())
    return (
  ...
  try {
    ...
    return (S.call(this, `Invalid configuration.`, e.message), V.failure());
  }
  try {
    if (!o(t.container)[0]) throw Error(`Invalid container.`);
  } catch (e) {
    return (S.call(this, e.message), V.failure());
  }
  return (
    (Q = t),
    (!Q.mobile && O()) || (!Q.desktop && !O())
      ? (S.call(
          this,
...
var B,
  ...
  me = e(() => {
    (s(),
      ...
      (V = { success: y, failure: v }),
      (H = (function () {
        var e = {},
          t = document.documentElement.style;
        function n(n, r) {
          if ((r === void 0 && (r = t), n && typeof n == `string`)) {
            if (e[n]) return e[n];
            if (typeof r[n] == `string`) return (e[n] = n);
            if (typeof r[`-webkit-` + n] == `string`)
              return (e[n] = `-webkit-` + n);
...
t(() => {
  me();
  var e = document.querySelectorAll(`nav a`);
  e.forEach((t) => {
  ...
  var t = z({ distance: `60px`, duration: 2500, delay: 400, reset: !0 });
  (t.reveal(`.hero h1`, { delay: 200, origin: `top` }),
    t.reveal(`.hero p`, { delay: 200, origin: `top` }),
    t.reveal(`.hero .btn`, { delay: 200, origin: `top` }),
    t.reveal(`.content-area`, { delay: 300, origin: `left` }),
    t.reveal(`.image-area`, { delay: 400, origin: `right` }));
})();
